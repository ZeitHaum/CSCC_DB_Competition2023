...
class Planner {
   ...
   private:
    ...
    bool get_index_cols(const std::string& tab_name, std::vector<Condition> &curr_conds, std::vector<std::string>& index_col_names);

    bool get_index_range_cols(const std::string& tab_name, std::vector<Condition> &curr_conds, std::vector<std::string>& index_col_names);
