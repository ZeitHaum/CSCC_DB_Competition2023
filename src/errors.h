...
class IndexNodeDeletePosError : public RMDBError {
   public:
    IndexNodeDeletePosError() : RMDBError("The pos of key overflow in index node!") {}
};
...
class InvalidValueError : public RMDBError{
    public:
    InvalidValueError(const std::string& msg) : RMDBError("Invalid value" + msg) {}
};
